...
<body>
<h1>仓库管理系统登录注册<sup>2016</sup></h1>
<div class="login" style="margin-top: 50px;">
    <div class="header">
        <div class="switch" id="switch">
            <a class="switch_btn_focus" id="switch_qlogin" href="javascript:void(0);" tabindex="7">快速登录</a>
            <a class="switch_btn" id="switch_login" href="javascript:void(0);" tabindex="8">快速注册</a>
            <div class="switch_bottom" style="position: absolute;width: 64px;left: 0px;"></div>
        </div>
    </div>
        ...
        <div class="web_login" id="web_login">
            <div class="login-box">
                <div class="login_form">
                    <form action="/userAction/login" name="loginform" accept-charset="UTF-8" id="login_form"
    ...
    <div class="qlogin" id="qlogin" style="display: none">
        <div class="web_login">
            <form name="form2" id="regUser" accept-charset="utf-8" action="/userAction/reg" method="post">
